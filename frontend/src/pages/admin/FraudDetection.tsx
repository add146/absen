...
const FraudDetection: React.FC = () => {
    ...
    const getScoreBadge = (score: number) => {
        if (score >= 70) return <span className="px-2 py-1 bg-red-100 text-red-800 rounded font-semibold">High Risk ({score})</span>;
        if (score >= 40) return <span className="px-2 py-1 bg-orange-100 text-orange-800 rounded font-semibold">Medium ({score})</span>;
        return <span className="px-2 py-1 bg-yellow-100 text-yellow-800 rounded font-semibold">Low ({score})</span>;
    };
    ...
    return (
        <div className="p-6 max-w-7xl mx-auto">
            <div className="mb-6">
                ...
                <p className="text-gray-600 mt-1">Monitor suspicious attendance patterns</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <div className="bg-white rounded-lg shadow p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-gray-600">Mock Location</p>
                ...
                <div className="bg-white rounded-lg shadow p-4">
                    <div className="flex items-center justify-between">
                        <div>
                            <p className="text-sm text-gray-600">Impossible Travel</p>
                                ...
                                <tr key={item.id}>
                                    ...
                                    <td className="px-6 py-4 text-sm text-gray-500">
                                        <div className="flex flex-wrap gap-1">
                                            ...
                                            {fraudData?.impossible_travel && <span className="px-2 py-1 bg-orange-50 text-orange-700 text-xs rounded">Impossible Travel</span>}
                                            {fraudData?.unusual_time && <span className="px-2 py-1 bg-yellow-50 text-yellow-700 text-xs rounded">Unusual Time</span>}
                                        </div>
                                    </td>
                                </tr>
                            );
